# Memory Puzzle
# By Sriteja, inspired from Memory Puzzle by Al Sweigart
...
assert(BOARDHEIGHT * BOARDWIDTH) % 2 == 0, 'Board needs to have an even number of boxes for pairs and matches.'
...
def splitIntoGroupsOf(groupSize, theList):
    # splits a list into a list of lists, where the inner lists have atmost groupSize number of items
    result = []
